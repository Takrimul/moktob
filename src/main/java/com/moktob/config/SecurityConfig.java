...
public class SecurityConfig {
    ...
    private final WebAuthenticationContextFilter webAuthenticationContextFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .addFilterBefore(webAuthenticationContextFilter, UsernamePasswordAuthenticationFilter.class)
